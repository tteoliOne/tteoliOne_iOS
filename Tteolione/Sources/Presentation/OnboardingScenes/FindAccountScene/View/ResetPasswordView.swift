...
final class ResetPasswordView: BaseView {
    ...
    private let explanations: [AppPasswordExplain] = [
    ...
    let completeResetButton = JoinButton(title: .completeResetPassword)
    
    override func configureHierarchy() {
        [topBarView, iconWithLabelView,
         boundarView, completeResetButton,
    ...
    override func configureLayout() {
        ...
        completeResetButton.snp.makeConstraints { make in
