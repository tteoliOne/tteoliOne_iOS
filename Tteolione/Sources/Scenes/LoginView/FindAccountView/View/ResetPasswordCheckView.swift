...
final class ResetPasswordCheckView: BaseView {
    ...
    override func configureHierarchy() {
        [topBarView, userNameIconWithLabelView,
         ...
         idIconWithLabelView, idInputTextField,
         idBoundarView, emailIconWithLabelView,
         emailInputTextField, emailBoundarView,
         explanationLabel, checkButton].forEach { addSubview($0) }
    }
    ...
    override func configureLayout() {
        ...
        idIconWithLabelView.snp.makeConstraints { make in
            make.leading.equalTo(topBarView.snp.leading).offset(12)
            make.top.equalTo(userNameBoundarView.snp.bottom).offset(20)
        }
        
        idInputTextField.snp.makeConstraints { make in
            make.horizontalEdges.equalTo(safeAreaLayoutGuide).inset(40)
            make.top.equalTo(idIconWithLabelView.snp.bottom).offset(20)
            make.height.equalTo(40)
        }
        
        idBoundarView.snp.makeConstraints { make in
        ...
        emailIconWithLabelView.snp.makeConstraints { make in
            make.leading.equalTo(topBarView.snp.leading).offset(12)
            make.top.equalTo(idBoundarView.snp.bottom).offset(20)
        }
    ...
    override func configureView() {
        ...
        idIconWithLabelView.configure(icon: .id,
